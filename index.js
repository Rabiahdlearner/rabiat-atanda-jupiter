...
console.log("The variable I made false is: ", warmToday);
...
console.log(myBio, " but live in ", priResi);
...
// Don't forget your console.logs!
console.log(addNum -= sumDisguise);
...
console.log("Rabiat's weird initials should be " + weirdInitials.toUpperCase())
...
// Don't forget your console.logs!
console.log("it is " + answer7 + " that " + firstName + " has weird initials")
/*/ ---------- QUESTION 8. ----------
...
if (firstName = "Rabiat"){
  ...
  console.log(firstName += "'s age, which is " + message)
}
...
// Don't forget your console.logs!
console.log(`I have to wait  ${days}days and  ${extraHours}hours  for vacation to evetually come`)
...
*/
// PUT YOUR CODE HERE
console.log("mind is blank right now")
// Don't forget your console.logs!
