...
// Write a function called 'repeat' that takes 1 integer parameter and, using a for or while loop, prints out the string "Hello World!" to the console the same number of times as the parameter. NOTE: for this question, since your console log should be inside your function, you only need to call/invoke the function after you write it rather than call/invoke it inside of a console.log.
    ...
    digit = 5
    console.log("Q2:", pyramidCounting(digit));
    ...
    function noVowel(str) {
      ...
      for (let char of str.toLowerCase()) {
        if (str.char === vowels.char) {
          return str1 = str[str.char != vowels.char];
        } else {
          return str;
        }
  ...
  let names = "Bolutife";//["B", "o","l", "u", "t", "i", "f", "e"]
  //"Bolutife";
     
  console.log("Q3:", noVowel(names))
    ...
    console.log("Q4", vowelCount(names))
    ...
    // PUT YOUR CODE HERE
    let empty =[];
    let full = ["Tola is", 24, "years old"];
    arrayChecker = function(array){
      if (array.length === 0 ) {
        return "true";
      } else
      {return "false"}
    }
console.log("Q7", arrayChecker(empty));
    ...
    console.log("Q8:", getElementAt(full, 2), getElementAt(names, 0), getElementAt(empty, 0))
    ...
    // PUT YOUR CODE HERE
    insertInArray = function(arr) {
      let newArr = arr.splice(1, 0, 0);
      return newArr;
    }

    console.log("Q8:", full, insertInArray(full));
    console.log("Q8:", full);
    console.log("Q8:", full.splice(1, 0, "0"));
    console.log("Q8:", insertInArray(full));
    console.log("Q8:", insertInArray(empty));//I dont understand Q8 result
    ...
    compareArrays = function(arr1, arr2) {
     ...
     let part = full.slice(3);
     console.log("Q9:", part)
     console.log("Q9:", empty)
     console.log("Q9:", compareArrays(full, empty))
     console.log("Q9:", compareArrays(full, part))
    ...
    // PUT YOUR CODE HERE
    let numbers = [23, 12, 222];
    calculateTotal = function(arr){
      let sumNum = arr.reduce((total, current)=>total+current);
      return sumNum;
    ...
    let findEvens = function(arrEvens){
      let evens = arrEvens.filter((num) => num % 2 === 0);
      return evens;
    }
    

    let findOdds = function(arrOdds){
      let odds = arrOdds.filter((num) => num % 2 === 1);
      return odds;
    }
    console.log("Q11:", findEvens(numbers));
    console.log("Q11:", findOdds(numbers))
    // EXAMPLE LOG:
    ...
    makeSquares = function(arr){
      squared = arr.map((num) => num ** 2);
      return squared;
    }

    console.log("Q12:", makeSquares(numbers));
    // EXAMPLE LOG:
